...
(function (factory) {
    ...
    $.extend(true, DataTable.ext.classes, {
        container:
            "dt-container dt-tailwindcss text-sm font-medium text-center",
        search: {
        ...
        length: {
            select: "border px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500 text-sm font-medium",
        },
        processing: {
        ...
        paging: {
            ...
            button: "rounded-lg relative inline-flex justify-center items-center space-x-2 border px-4 py-2 -mr-px leading-6 hover:z-10 focus:z-10 active:z-10 border-gray-200 active:border-gray-200 active:shadow-none dark:border-gray-700 dark:active:border-gray-700",
            first: "rounded-l-lg",
            last: "rounded-r-lg",
            enabled:
        ...
        table: "dataTable min-w-full text-sm align-middle whitespace-nowrap font-medium",
        thead: {
    ...
    DataTable.ext.renderer.pagingContainer.tailwindcss = function (
        ...
        return $("<ul/>")
            .addClass(
                "pagination fi-pagination-item group/item border-gray-200 first:border-s-0 last:border-e-0 dark:border-white/10"
            )
            .append(buttonEls);
    };
